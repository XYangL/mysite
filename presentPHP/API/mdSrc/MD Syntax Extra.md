...
For Example -- Block inside aparagraph: In modern language, Newton's law of universal gravitation is Every point mass attracts every single other point mass by a force pointing along the line intersecting both points. $$ F = G \frac{m\_1 m\_2}{r^2} $$  The force is proportional to the product of the two masses and inversely proportional to the square of the distance between them. [^2]
...
![Task Model](images/TaskModel.png )

- **Planning** is the phase of collecting the materials (content elements)  of the presentation. 
- **Editing** is the phase of relating the basic elements to others ( based on some rules)
	...
	- animation is generated by relating style to other style
	- transition is generated by relating animation to other animation
- **Rehearsing** is the phase of adjusting the relations according to the actual situation
- **Delivering** is the phase of controlling the dynamic elements to be applied to the static elements, that is taking actions to navigate through the content elements.
- **Sharing** is the phase of presenting the contents with their original structure in a different way
